...
<dict>
	...
	<dict>
		...
		<array>
			...
			<dict>
				<key>Comment</key>
				<string>SSDT-NoHybGfx.aml</string>
				<key>Enabled</key>
				<true/>
				<key>Path</key>
				<string>SSDT-NoHybGfx.aml</string>
		...
		<array>
			...
			<dict>
				...
				<integer>0</integer>
				<key>Comment</key>
				<string>HPTL to XPTL rename - requires SSDT-LID0.aml</string>
				<key>Count</key>
				<integer>1</integer>
				<key>Enabled</key>
				<true/>
			...
			<dict>
				...
				<integer>0</integer>
				<key>Comment</key>
				<string>_Q80 to XQ80 rename - requires SSDT-LID0.aml</string>
				<key>Count</key>
				<integer>1</integer>
				<key>Enabled</key>
				<true/>
	...
	<dict>
		...
		<array>
			...
			<dict>
				...
				<key>Comment</key>
				<string>V1.1.2 | RestrictEvents.kext</string>
				<key>Enabled</key>
				<true/>
				<key>ExecutablePath</key>
			...
			<dict>
				...
				<string>Any</string>
				<key>BundlePath</key>
				<string>GenericUSBXHCI.kext</string>
				<key>Comment</key>
				<string>V1.3.0b2</string>
				<key>Enabled</key>
				<true/>
				<key>ExecutablePath</key>
				<string>Contents/MacOS/GenericUSBXHCI</string>
				<key>MaxKernel</key>
				<string></string>
				<key>MinKernel</key>
				<string></string>
			...
			<dict>
				...
				<string>Any</string>
				<key>BundlePath</key>
				<string>AirportItlwmMonterey.kext</string>
				<key>Comment</key>
				<string>AirportItlwmMonterey.kext</string>
				<key>Enabled</key>
				<true/>
			...
			<dict>
				...
				<key>Comment</key>
				<string>V1.8.5 | AppleALC.kext</string>
				<key>Enabled</key>
				<false/>
				<key>ExecutablePath</key>
			...
			<dict>
				...
				<key>Comment</key>
				<string>V1.1.5 | FeatureUnlock.kext</string>
				<key>Enabled</key>
				<false/>
				<key>ExecutablePath</key>
			...
			<dict>
				...
				<key>Comment</key>
				<string>V2.2.0 | AirportItlwm.kext</string>
				<key>Enabled</key>
				<false/>
				<key>ExecutablePath</key>
				<string>Contents/MacOS/AirportItlwm</string>
			...
			<dict>
				...
				<key>Comment</key>
				<string>V2.6.8 | BlueToolFixup.kext</string>
				<key>Enabled</key>
				<true/>
				<key>ExecutablePath</key>
			...
			<dict>
				...
				<key>Comment</key>
				<string>V2.3.0 | IntelBTPatcher.kext</string>
				<key>Enabled</key>
				<false/>
				<key>ExecutablePath</key>
			...
			<dict>
				...
				<key>Comment</key>
				<string>V2.3.0 | IntelBluetoothFirmware.kext</string>
				<key>Enabled</key>
				<true/>
				<key>ExecutablePath</key>
	...
	<dict>
		...
		<dict>
			...
			<dict>
				...
				<integer>1</integer>
				<key>revcpuname</key>
				<string>AMD Ryzen™ 7 5800H</string>
			</dict>
	...
	<dict>
		...
		<dict>
			...
			<false/>
			<key>MLB</key>
			<string>C02129404J9PHC1JC</string>
			...
			<string>C02G3QZQPN5T</string>
			<key>SystemUUID</key>
			<string>CD547784-4384-4D0E-95B8-41D55520E3EF</string>
		</dict>
	...
	<dict>
		...
		<dict>
			...
			<integer>0</integer>
			<key>AudioDevice</key>
			<string>PciRoot(0x1)/Pci(0x8,0x1)/Pci(0x0,0x6)</string>
